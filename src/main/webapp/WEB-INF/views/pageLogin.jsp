	...
	<div>
		...
		<div class="col-md-8 offset-md-2 loginbox">
			...
			<form method="post" action="./loginHere">
				<div class="col-md-5">
					<h5>LOGIN</h5>
					<input type="text" name="username" id="username" class="inputtext" value="Admin"></input>
				</div>
				<div class="col-md-5">
					<h5>PASSWORD</h5>
					<input type="password" name="password" id="password" class="inputtext" value="admin@123"></input>
				</div>
				<div class="col-md-5">
